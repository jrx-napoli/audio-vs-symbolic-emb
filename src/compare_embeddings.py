...
class ComparisonRunner:
    ...
    def __init__(self, h5_path: str, output_dir: str, label_name: str, embedding_type: str):
        """
        ...
        Args:
            ...
            label_name: Name of the label to use for visualization
        ...
        try:
            with h5py.File(self.h5_path, 'r') as f:
                ...
                for key in audio_group.keys():
                    ...
                    embedding = np.array(audio_group[key][embedding_type])
                ...
                for key in symbolic_group.keys():
                    ...
                    label = self._get_simplified_label(label)
                    embedding = np.array(symbolic_group[key][embedding_type])
    ...
    def _create_visualization(self, embeddings, labels, title, output_path):
        """Create PCA, t-SNE, and UMAP visualizations for embeddings."""
    ...
    def analyze_results(self) -> None:
        """Create visualizations and analyze clustering for audio and symbolic embeddings."""
        logger.info("Creating visualizations...")
        
        # Create visualization for audio embeddings
        ...
        # Create visualization for symbolic embeddings
        self._create_visualization(
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Analyze audio and symbolic embeddings separately by class"
    )
    parser.add_argument(
        "--h5_path",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Name of the label to use for visualization (e.g., 'style', 'genre')",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
